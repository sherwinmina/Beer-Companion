    ...
    return <div>
        <div className="route-container">
          <div className="secondary-route">
            <Link to="/hops" className={activeItem === "About" ? "line" : "regular"} name="About" onClick={this.handleChange}>
              About Hops
            </Link>
          </div>
          <div className="secondary-route">
            <Link to="/hops/guide" className={activeItem === "Guide" ? "line" : "regular"} name="Guide" onClick={this.handleChange}>
              Hops Guide
            </Link>
          </div>
          <div className="secondary-route">
            <Link to="/hops/list" className={activeItem === "Hop-List" ? "line" : "regular"} name="Hop-List" onClick={this.handleChange}>
              List of Hops
            </Link>
          </div>
        </div>
